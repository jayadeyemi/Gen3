...
temps = ["temp1", "temp2", "temp3", "temp4"]  # Intermediate output folders
final = "combined"                  # Final intermediate output folder
...
scripts = [
    ...
    (os.path.join(script_dir, 'traverser.py')   , [temps[2], temps[3]]),
    (os.path.join(script_dir, 'combine.py')     , [temps[3], final]),
    (os.path.join(script_dir, 'combine2.py'), [temps[2], final + '/nested.yaml'])
]
